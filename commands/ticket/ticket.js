        ...
        collector.on('collect', async (interaction) => {
          if (interaction.isButton()) {
            if (interaction.customId === 'body_ticket') {
              ...
              let authorName = '';
              const authorIcon = guideTicket.author ? guideTicket.author.avatarURL({  dynamic: true }) : null;
              ...
              messageCollector.on('collect', async (collectedMessage) => {
                ...
                if (!guideTicket.author) {
                  ...
                  guideTicket.setAuthor(authorName, guideTicket.author.avatarURL({dynamic: true}), guideTicket.author.url);
                }
