        ...
        switch (args[0]) {
            case 'config':
                ...
                if (HumanRole === 'na') {
                    ...
                    invcHumanRoleString = humanrole ? `[1] | [${humanrole.id}](https://discord.gg/eroshq) | \`${humanrole.name}\`` : `\`Invalid Role ID\``;
                }
                ...
                if (BotRole === 'na') {
                    ...
                    invcBotRoleString = botrole ? `[1] | [${botrole.id}](https://discord.gg/eroshq) | \`${botrole.name}\`` : `\`Invalid Role ID\``;
                }
                ...
                embed.setFooter(`Made by Ace Development`, arypton.displayAvatarURL({ dynamic: true }));
