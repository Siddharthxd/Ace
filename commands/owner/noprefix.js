...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const guide = new MessageEmbed()
      ...
      .addField(`<:axery_arrow:1243170991266332703> ${prefix}noprefix add <user> all`, `Add a user to noprefix users for all servers.`)
      .addField(`<:axery_arrow:1243170991266332703> ${prefix}noprefix remove <user> all`, `Remove a user from noprefix users from all servers.`)
      .addField(`<:axery_arrow:1243170991266332703> ${prefix}noprefix show`, `Shows all the users in noprefix database.`)
      .addField(`<:axery_arrow:1243170991266332703> ${prefix}noprefix reset`, `Removes all the users from noprefix users from the database.`)
