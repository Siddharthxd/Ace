...
async function sendHelpEmbed(client, message) {
  ...
  const helpEmbed = new MessageEmbed()
    ...
    .addField(`<:axery_arrow:1243170991266332703> \`vanity config\``, `Shows vanity role settings for the server.`)
    .addField(`<:axery_arrow:1243170991266332703> \`vanity guide\``, `Shows the guide for vanity role settings.`)
    .addField(`<:axery_arrow:1243170991266332703> \`vanity set role <role>\``, `Setups vanity role settings for the server.`)
    .addField(`<:axery_arrow:1243170991266332703> \`vanity set vanity <vanity>\``, `Setups vanity role link settings for the server.`)
    .addField(`<:axery_arrow:1243170991266332703> \`vanity set channel <channel>\``, `Setups vanity role settings for the server.`)
    .addField(`<:axery_arrow:1243170991266332703> \`vanity reset\``, `Resets vanity role for the server.`)
    .setFooter(`Made by Ace Development`, `${arypton.displayAvatarURL({ dynamic: true })}`);
...
async function sendConfigEmbed(client, message) {
  ...
  const configEmbed = new MessageEmbed()
    ...
    .addField(`<:axery_arrow:1243170991266332703> Vanity Role:`, vanityRole === 'Not set' ? '`Not set`' : `<@&${vanityRole}>`)
    .addField(`<:axery_arrow:1243170991266332703> Vanity URL:`, vanityURL === 'Not set' ? '`Not set`' : `.gg/${vanityURL}`)
    .addField(`<:axery_arrow:1243170991266332703> Vanity Channel:`, vanityChannel)
    .setFooter(`Made by Ace Development`, `${arypton.displayAvatarURL({ dynamic: true })}`);
