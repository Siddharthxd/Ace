...
- ${emoji.util.arrow} Auto Recovery [[Premium](${Settings.bot.credits.supportServer})]`
      ...
      .addField(`Links`, `• Join the [Ace support server](${Settings.bot.credits.supportServer}) if you require assistance.`, false)
      .setFooter(`Developed by Ace Development`, `${arypton.displayAvatarURL({ dynamic: true })}`);
